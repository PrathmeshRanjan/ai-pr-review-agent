...
1. Go to test repo: https://github.com/example-org/test-pr-review-demo
...
```bash
# Via GitHub CLI
gh pr edit 11 --add-reviewer example-org
...
Go to: https://github.com/example-org/test-pr-review-demo/pull/11
