...
1. **Create Blueprint Deployment**:
   ...
   - Select: `example-org/ai-pr-review-agent`
   - Branch: `main`
...
```bash
# Database (Neon Cloud)
DATABASE_URL=postgresql+asyncpg://user:password@your-neon-host.neon.tech/neondb?ssl=require

# Redis (Upstash Cloud)  
REDIS_URL=rediss://default:your-redis-password@your-redis-host.upstash.io:6380
